...
erDiagram
    ROL ||--o{ USUARIO : tiene
    USUARIO ||--o| CLIENTES : es
    USUARIO ||--o| EMPRESAS : es
    USUARIO ||--o| ADMINISTRADORES : es
    USUARIO ||--o{ RECINTO : "administra (empresa)"
    USUARIO ||--o{ EVENTO : "organiza (empresa)"
    USUARIO ||--o{ COMPRA : "realiza (cliente)"
    USUARIO ||--o{ RESERVA : "reserva (cliente)"
    RECINTO ||--o{ ZONA : contiene
    RECINTO ||--o{ FECHAS_EVENTOS : hospeda
    EVENTO ||--o{ FECHAS_EVENTOS : tiene
    EVENTO ||--o{ BOLETO_EVENTO : ofrece
    ZONA ||--o{ BOLETO_EVENTO : "corresponde a"
    BOLETO_EVENTO ||--o{ DETALLE_COMPRA : "aparece en"
    BOLETO_EVENTO ||--o{ RESERVA : "se reserva en"
